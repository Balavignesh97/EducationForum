...
$('#FirstName, #email, #Mobile,#Password,#ConfirmPassword').on('input', function (event) {
...
async function Validatecheck(Id = null) {
    ...
    return firstname.val() && isValidEmail && isValidPhone && password && confirmpassword && validatePassword();
}
